    ...
    <form action="update_penulis.php" method="POST">
        <table border='1px'>
            ...
            <tr>
                <td>Jenis Kelamin</td>
                <td>
                    <input type="radio" name="jk" value="L" <?php if ($data['jk'] == 'L') {
                                                                echo "checked";
                                                            } ?> required>Laki Laki
                    <input type="radio" name="jk" value="P" <?php if ($data['jk'] == 'P') {
                                                                echo "checked";
                                                            } ?> required>Perempuan
                </td>
            </tr>
            ...
            <tr>
                <td>Alamat</td>
                <td>
                    <textarea name="alamat_penulis" id="" cols="21" rows="2"><?php echo $data['alamat_penulis']; ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2">
